...
- Prevent building any of the 4 structures or disable their core functions
- Prevent players from earning Source or disable any existing way to earn it
- Change the daily winner mechanic — highest Source always wins
- Prevent new daily rules from being added or disable rule submission
